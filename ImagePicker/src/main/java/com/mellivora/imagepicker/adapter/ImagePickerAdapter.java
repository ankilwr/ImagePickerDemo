package com.mellivora.imagepicker.adapter;
...
import com.mellivora.imagepicker.data.ItemType;
...
import com.mellivora.imagepicker.view.SquareImageView;
import com.mellivora.imagepicker.view.SquareRelativeLayout;
...
public class ImagePickerAdapter extends RecyclerView.Adapter<ImagePickerAdapter.BaseHolder> {
    ...
    public void onBindViewHolder(@NonNull BaseHolder holder, final int position) {
        ...
        switch (itemType) {
            ...
            case ItemType.ITEM_TYPE_IMAGE:
                MediaHolder imageHolder = (MediaHolder) holder;
                bindMedia(imageHolder, mediaFile, ConfigManager.getInstance().isImageSingle());
                break;
            case ItemType.ITEM_TYPE_VIDEO:
                MediaHolder videoHolder = (MediaHolder) holder;
                bindMedia(videoHolder, mediaFile, ConfigManager.getInstance().isVideoSingle());
                break;
            //相机Item
            default:
                break;
     ...
     * @param mediaFile
     */
    private void bindMedia(MediaHolder mediaHolder, MediaFile mediaFile, Boolean isSingleCheck) {
//        if (ConfigManager.getInstance().isSingleType()) {
//            mediaHolder.mImageCheck.setVisibility(isSingleCheck ? View.GONE : View.VISIBLE);
//        }
        ...
        ConfigManager.getInstance().getImageLoader().loadImage(mediaHolder.mImageView, mediaFile);
